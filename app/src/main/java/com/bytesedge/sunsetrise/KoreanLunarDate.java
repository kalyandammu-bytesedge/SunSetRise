...
import com.bytesedge.sunsetrise.KoreanLunarCalendarUtils;

public final class KoreanLunarDate {

    KoreanLunarCalendarUtils koreanLunarCalendarUtils;
    /**
     * Value of solar year.
     */
    ...
    private KoreanLunarDate(final int solYear, final int solMonth, final int solDay,
        ...
        this.dailyCycleDesc = koreanLunarCalendarUtils.getSexagenaryCycleChinese(dailyCycle) + ", " +
                koreanLunarCalendarUtils.getSexagenaryCycleKorean(dailyCycle);
        this.monthlyCycleDesc = koreanLunarCalendarUtils.getSexagenaryCycleChinese(monthlyCycle) + ", " +
                koreanLunarCalendarUtils.getSexagenaryCycleKorean(monthlyCycle);
        this.yearlyCycleDesc = koreanLunarCalendarUtils.getSexagenaryCycleChinese(yearlyCycle) + ", " +
                koreanLunarCalendarUtils.getSexagenaryCycleKorean(yearlyCycle);
    }
